...
export default function NuevoObjetivo({ navigation }) {
    ...
    const agregarObjetivo = () => {
        console.log("Objetivo agregado:", objetivo);
        setObjetivo('');
    };
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.title}>
                <Image source={require('./../../assets/agregar-objetivo.png')} style={styles.icon1} resizeMode="contain" />
                <Text style={styles.titleText}>Nuevo Objetivo</Text>
            </View>
            
            <View style={styles.inputContainer}>
                <TouchableOpacity onPress={agregarObjetivo} style={styles.checkButton}>
            ...
            >
                <Text style={styles.buttonText}>Registrar Objetivo</Text>
            </TouchableOpacity>
